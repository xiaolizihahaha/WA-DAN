import pandas as pd
df = pd.read_excel('D:/data/tttt1-1.xlsx')
...
# 将内容写入 txt 文件
with open("./datasets/CUB_200_2011(VVV4-18)/image_class_labels.txt", "w") as file:
...
# 将内容写入 txt 文件
with open("./datasets/CUB_200_2011(VVV4-18)/images.txt", "w") as file:
    for line in file_lines:
        file.write(line + "\n")
...
# 将内容写入 txt 文件
with open("./datasets/CUB_200_2011(VVV4-18)/train_test_split(all).txt", "w") as file:
    for line in file_lines:
        file.write(line + "\n")
...
# 将内容写入 txt 文件
with open("./datasets/CUB_200_2011(VVV4-18)/masks.txt", "w") as file:
    for line in file_lines:
        file.write(line + "\n")
